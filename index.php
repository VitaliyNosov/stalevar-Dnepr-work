<?php get_header(); ?>
    ...
    <section class="container-content"> 
		...
		<?php if (is_home()) { query_posts($query_string.'&cat=-1&showposts=10'); } ?>
			<?php if (have_posts()) :  while (have_posts()) : the_post(); ?>
			
        	<article class="block-catalog">
			
			<a href="<?php the_permalink(); ?>"><?php echo get_the_post_thumbnail( $page->ID, 'thumbnail'); ?></a>
			
            	<h2 class="catalog-metal"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
                <!--<?php the_excerpt(); ?>-->
